...
for root, dirs, files in os.walk(os.path.join(os.getcwd(),base_directory,"drowsy")):
    for file in files[:2]:
        ...
        if not file.endswith('.txt'):
            ...
            if folder_name=='42' or folder_name=='43' or folder_name=='44':
                valid_drowsy=np.append(valid_drowsy,file)
            elif folder_name=='45' or folder_name=='46' or folder_name=='47' or folder_name=='48':
                test_drowsy=np.append(test_drowsy,file)
            else:
                train_drowsy=np.append(train_drowsy,file)

print("test_drowsy:",len(test_drowsy)," test_alert:",len(test_alert)," test_lowVigilant=",len(test_lowVigilant))
print("valid_drowsy:",len(valid_drowsy)," valid_alert:",len(valid_alert)," valid_lowVigilant=",len(valid_lowVigilant))
print("train_drowsy:",len(train_drowsy)," train_alert:",len(train_alert)," train_lowVigilant=",len(train    lowVigilant))
...
for i in range(validation_split-int(validation_split*0.5)):
